...
async def get_flashcard(
    request: Request,
    response: Response,
    flashcard_id: Annotated[uuid.UUID, Path(
    ...
    try:
        ...
        log_with_context(
            ...
            extra_context={
                ...
                "update_fields": [field for field, value in patch_data.model_dump(exclude_unset=True).items() if value is not None]
            }
        )
