...
class TestAiGenerationStatsEndpoint:
    ...
    def test_generation_stats_success_with_defaults(self, mock_get_supabase):
        ...
        response = self.client.get(
            "/api/v1/ai/generation-stats", headers=self.auth_headers
        )
    ...
    def test_generation_stats_with_pagination(self, mock_get_supabase):
        ...
        # Act
        response = self.client.get(
            "/api/v1/ai/generation-stats?page=2&size=10", headers=self.auth_headers
        )
    ...
    def test_generation_stats_max_page_size(self, mock_get_supabase):
        ...
        # Act
        response = self.client.get(
            "/api/v1/ai/generation-stats?page=1&size=100", headers=self.auth_headers
        )
    ...
    def test_generation_stats_unauthorized_invalid_token(self, mock_get_supabase):
        ...
        # Act
        response = self.client.get(
            "/api/v1/ai/generation-stats", headers=invalid_headers
        )
    ...
    def test_generation_stats_invalid_query_params(self):
        ...
        # Act - Invalid page (< 1)
        response = self.client.get(
            "/api/v1/ai/generation-stats?page=0", headers=self.auth_headers
        )
        ...
        # Act - Invalid size (< 1)
        response = self.client.get(
            "/api/v1/ai/generation-stats?size=0", headers=self.auth_headers
        )
        ...
        response = self.client.get(
            "/api/v1/ai/generation-stats?size=150", headers=self.auth_headers
        )
