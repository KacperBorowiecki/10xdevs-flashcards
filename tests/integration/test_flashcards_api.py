...
class TestFlashcardsListEndpoint:
    ...
    def test_list_flashcards_success_with_defaults(self, mock_get_supabase):
        ...
        mock_supabase.table.return_value.select.return_value.eq.return_value.eq.return_value.limit.return_value.offset.return_value.order.return_value.execute.return_value = mock_query_response
        mock_supabase.table.return_value.select.return_value.eq.return_value.eq.return_value.execute.return_value = mock_count_response
    ...
    def test_list_flashcards_with_query_params(self, mock_get_supabase):
        ...
        # Setup method chaining
        mock_supabase.table.return_value.select.return_value.eq.return_value.eq.return_value.eq.return_value.limit.return_value.offset.return_value.order.return_value.execute.return_value = mock_query_response
        mock_supabase.table.return_value.select.return_value.eq.return_value.eq.return_value.eq.return_value.execute.return_value = mock_count_response
    ...
    def test_list_flashcards_pagination(self, mock_get_supabase):
        ...
        # Mock database response
        mock_query_response = Mock()
        mock_query_response.data = [self.sample_flashcards[0]]  # Second page with 1 item
        mock_count_response = Mock()
        ...
        # Act
        response = self.client.get(
            "/api/v1/flashcards?page=2&size=20",
            headers=self.auth_headers
        )
    ...
    def test_list_flashcards_invalid_query_params(self):
        ...
        # Act - Invalid status
        response = self.client.get(
            "/api/v1/flashcards?status=invalid_status",
            headers=self.auth_headers
        )
...
class TestFlashcardsDeleteEndpoint:
    ...
    def test_delete_flashcard_success(self, mock_get_supabase):
        ...
        mock_table_get.select.return_value.eq.return_value.eq.return_value.limit.return_value.execute.return_value = mock_get_response
        
        # Setup DELETE operation chain
        mock_table_delete.delete.return_value.eq.return_value.eq.return_value.execute.return_value = mock_delete_response
